  ...
  return (
    ...
    animate={{x: 0}}>
      <div className="px-4 mt-2 text-center">
        <h1 className="text-4xl md:text-6xl text-gray-700">Some of my work...👨‍💻</h1>
        <p className="text-base pt-7 text-gray-700">Here are a few design projects I've worked on recently. Want to see more?</p>
      </div>
          ...
          <div className='flex flex-col max-w-sm shadow-xl cursor-pointer'>
            ...
            <div>
              ...
              <div>
                ...
                <button className='bg-blue-600 ml-5 ny-3 rounded-md py-1 px-3 text-white text-xl'>
                  <a href={project.link}>Github</a>
                </button>

                <button className='bg-red-600 ml-5 ny-3 rounded-md py-1 px-3 text-white text-xl'>
              ...
              <div className='flex items-center text-center pb-2 mt-2'>
                ...
                <h1 className='bg-gray-300 px-3 py-1 rounded-md text-lg mt-4 ml-2'>{project.tech[2]}</h1>
